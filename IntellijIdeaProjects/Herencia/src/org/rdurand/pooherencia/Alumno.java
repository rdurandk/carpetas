package org.rdurand.pooherencia;
...
public class Alumno extends Persona{
    ...
    public Alumno(){
        super();//explicita-llamando al constructor del padre por defecto
    ...
    public Alumno(String nombre, String apellido, int edad,
                  String institucion, double notaMatematica, double notaHistoria,
