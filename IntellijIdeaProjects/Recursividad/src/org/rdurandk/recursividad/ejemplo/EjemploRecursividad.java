package org.rdurandk.recursividad.ejemplo;

import org.rdurandk.recursividad.ejemplo.models.Componente;
...
public class EjemploRecursividad {
    ...
    /*public static void metodoRecursivoJava8(Componente c, int nivel){
        System.out.println("\t".repeat(nivel) + c.getNombre());
        Stream.of(c).filter(f->f.tieneHijos()).forEach(el -> {
            for(Componente hijo: el.getHijos()){
